...
- We obtained a data set consisting of 159 variables along with a classification of the type of exercise performed. - - The data contained both categorical and continuous variables, as well as missing values.
...
- Summing the confusion matrices for each training iteration, and then dividing the sum of all diagonal entries by the sum of the entire matrix, results in a prediction of 0.005% out-of-sample error.
